...
//  2019-04-30: OpenGL: Added support for special ImDrawCallback_ResetRenderState callback to reset renderer state.
//  2019-03-29: OpenGL: Not calling glBindBuffer more than necessary in the renderer loop.
...
//  2018-02-23: OpenGL: Create the VAO in the renderer function so the setup can more easily be used with multiple shared GL context.
...
static void ImGui_ImplOpenGL3_SetupRenderState(ImDrawData* draw_data, int fb_width, int fb_height, GLuint vertex_array_object)
{
    ...
    // Setup renderer state: alpha-blending enabled, no face culling, no depth testing, scissor enabled, polygon fill
    glEnable(GL_BLEND);
